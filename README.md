...
<br />
 ...
 [![My Skills](https://skillicons.dev/icons?i=html,css,bash,docker,github,jest,linux,pnpm,postgres,redux,regex,sass,stackoverflow,tailwind,ts,ubuntu,vite,vitest,svg,bootstrap,materialui,jquery,js,react,babel,npm,webpack,nodejs,express,mongodb,gcp,firebase,heroku,postman,vercel,visualstudio,vscode,windows,powershell,git&perline=8)](https://skillicons.dev)
